...
You would need to call `add_friendship()` 500 times because each call will make two friendships and to get an average of 10 friends per 100 users you would need 1000 friendships and 100 \* 10 / 2 equals 500.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

From running my function I am getting around 99% of users will be in the network and the average degree of seperation to be ~5
